...
import { Box, Typography, Grid, Select, MenuItem, Paper, IconButton, Avatar, Chip } from "@mui/material";
    ...
    <AdminLayout>
      <Box sx={{ 
        ...
        <Grid container spacing={3} sx={{ mb: 3 }}>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <StatsCard
              icon={<CalendarMonthIcon sx={{ fontSize: 24, color: '#D4A017' }} />}
              title="Total Slots"
              value="148"
              color="#D4A017"
            />
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", mb: 1.5 }}>
                      <Avatar
                        sx={{
                          width: 40,
                          height: 40,
                          bgcolor: index === 0 ? '#8B0000' : index === 1 ? '#D4A017' : '#64748B',
                          mr: 2,
                        }}
                      >
                      ...
                      <Box sx={{ flexGrow: 1 }}>
                        ...
                        >
                          {faculty.bookings} bookings
                        </Typography>
                      </Box>
                    </Box>
                    <Box sx={{ position: "relative", height: 6, width: "100%", borderRadius: 3, bgcolor: "#f1f5f9" }}>
                      <Box
                        sx={{
                          position: "absolute",
                          top: 0,
                          left: 0,
                          width: `${(faculty.bookings / 50) * 100}%`,
                          height: "100%",
                          borderRadius: 3,
                          bgcolor: index === 0 ? '#8B0000' : index === 1 ? '#D4A017' : '#64748B',
                      ...
                      <Box sx={{ flexGrow: 1 }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                          ...
                          <Chip
                            ...
                            size="small"
                            sx={{
                              bgcolor: activity.status === 'Upcoming' ? 'rgba(139, 0, 0, 0.1)' : 'rgba(212, 160, 23, 0.1)',
                              color: activity.status === 'Upcoming' ? '#8B0000' : '#D4A017',
                              fontWeight: 500,
                              fontSize: '0.75rem',
                              height: 24,
                            }}
